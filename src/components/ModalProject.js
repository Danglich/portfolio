    ...
    return isShowing
        ? ReactDOM.createPortal(
              <div className="fixed top-0 left-0 right-0 z-[1000]  max-xl:px-[16px] h-[100vh] overflow-auto ">
                  ...
                  ></div>
                  <div className="w-[1200px] animate-[fadeDown_0.5s_ease] max-sm:mt-[50px] max-sm:px-[10px] px-[30px] mb-[80px] py-[30px] mx-auto max-lg:block relative z-[1001] mt-[80px] max-xl:w-full bg-[#252525] rounded-[8px] flex gap-[24px]">
                      <div className="flex-1 ">
                          <h1 className="font-[800] text-[#ffb400] dark:text-[#72b626] text-[32px] max-sm:text-[24px] inline-block w-full relative">
                              <span className="relative">
                                  MIKIYA KOBAYASHI
                                  <span className="block h-[3px] bg-[#ffb400] dark:bg-[#72b626] w-[50%] z-[1] bottom-[-3px] absolute"></span>
                              </span>
                      ...
                      <div className="flex-1 ">
                          ...
                          <p className="text-white  mt-[12px] font-[300]">
                              Demo -{' '}
                              <a
                                  className="text-[#ffb400] dark:text-[#72b626]"
                                  href={`${project.link}`}
                                  target="_blank"
                                  rel="noreferrer"
                              >
                      ...
                      >
                          <CloseIcon className="text-[#ffb400] dark:text-[#72b626]" />
                      </div>
                  </div>
              </div>,
              document.body,
