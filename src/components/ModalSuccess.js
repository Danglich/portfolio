    ...
    return isShowing
        ? ReactDOM.createPortal(
              <div className="fixed top-0 right-0 bottom-0 left-0 flex items-center justify-center z-[1000]">
                  <div className="bg-white relative w-[416px] max-sm:w-full rounded-[2px] pt-[70px] px-[16px] pb-[16px] text-center">
                      ...
                      <div className="mt-[16px] mb-[6px]">
                          <button
                              onClick={toggle}
                              className="w-[80%] bg-[white] hover:bg-[#4caf50] hover:text-white transition-all duration-[300ms] text-[#4caf50] py-[3px] border-[1px] border-[#4caf50] rounded-[30px]"
                          >
                              OK
                          </button>
                      </div>
